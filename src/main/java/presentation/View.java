...
public class View extends JFrame implements TableModelListener {
    ...
    /** The 2nd panel containing buttons for changing the table and for the operations. */
    private JPanel panel2;
    /**
     * The 3rd panel containing the header.
     */
    ...
    /** The label for tabels. */
    private JLabel tabels= new JLabel("Tabels");
    /** The label for title. */
    private JLabel name= new JLabel("ORDERS MANAGEMENT");
    /** The label for operations. */
    ...
    public void addFrame() {
        ...
        this.setName("ORDERS MANAGEMENET");
